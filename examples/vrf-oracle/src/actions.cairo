...
pub mod actions {
    ...
    use dojo_examples::vrf::request_vrf;
    ...
    impl ActionsImpl of IActions<ContractState> {
        ...
        fn spawn(ref world: IWorldDispatcher) {
            ...
            seed.append(42);
            let result = request_vrf(seed.span());
            assert(result == 1749760720107131022781690892024891617311129198096286233628341005792224087740, 'vrf result incorrect');
